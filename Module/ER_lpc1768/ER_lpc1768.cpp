...
/*-----------------PC モード用 パルス幅-----------------*/
#define UP_STAGE4    0.000030  //オーバーフロー ? 回転し続けてしまう
#define UP_STAGE3    0.000400  //オーバーフロー ? 回転し続けてしまう
...
#define DOWN_STAGE3  0.002620  //オーバーフロー ? 回転し続けてしまう
#define DOWN_STAGE4  0.002990  //オーバーフロー ? 回転し続けてしまう

#define LEFT_STAGE4  0.000030  //オーバーフロー ? 回転し続けてしまう
#define LEFT_STAGE3  0.000400  //オーバーフロー ? 回転し続けてしまう
...
#define RIGHT_STAGE3 0.002620  //オーバーフロー ? 回転し続けてしまう
#define RIGHT_STAGE4 0.002990  //オーバーフロー ? 回転し続けてしまう
